...
President Reagan (from 1981 to 1989) was also a TV star before being candidate, he was ridiculed as 'not serious candidate' and analysts said over and over that he could never win, he was also criticized as being 'extreme' and 'simplistic' and so on. They are so similar, they even share a very unique characteristic: there are the only presidents who got divorced.

On the political aspect, Trump and Reagan both have defended gun rights and the Second Amendment, and the latest is considered by the men as the amendment guarantying freedom in the country. They both favors tax reduction, especially corporate taxes ; the time will tell us if Trump will beat the tax rate championships in which Reagan is the all-time MVP. They both began as a Democrat before becoming Republican and at last but not least, they share a common ground on immigration. 

Now the question is, are their inaugural speeches similar? Do they reflect the same character? Indeed, the two Washington outsiders who constantly attacked the establishment, are extremely frank. They are both straight-talkers and don't hide behind political correctness. But, when it comes to their inaugural speeches, right after swearing on the bible, the message is not the same. 

In this analysis we will explore their speeches and their predecessors to find convergence and divergence between the two presidents.
...
- Down to earth vocabulary. They describe the economic landscape and geopolitical situation with simple and effective words like: Trump: "jobs", "factories", "workers", "trillions" (economy) "islamic", "border", "tunnels", "carnage" (geopolitics) and Reagan: "tax", "budget", "earning", "program" (economy) "nuclear", "weapon", "soviets", "kill" (geopolitics). That shows how close they want to appear to the people. They want to be understood, to have a straightforward message to the people so they use words that are tothepoint.
- Practical speech. They both address what the average american citizen needs the most: economy and security. The focus is on what matter the most for the people.
- Anti-establishment traits. Trump and Reagan built their speeches in contradiction with Obama and Carter speeches. Indeed, Obama and Carter are more metaphorical: "journey", "ambitions", "dream", "bible", "micah", "commitment", "spirituality". It is a totally different tone with a different purpose.
...
I use the "lexicon" package to assign a sentiment and strength score (-1, 0 or 1) to each word pronunced in the speeches and then average it with the attributed weights from the TF-IDF method. That gives a sentiment and strength scores for each speech in the US history and they are plotted above. 

- We notice first that a natural clustering can be done on the set of all speeches. Trump's, Reagan's and Carter's speeches are in the same cluster of (sentiment vs strength) whereas Obama is in another cluster. 
- Carter has a biblic introduction that may have higher both his sentiment score and strength score. 
...
Trump chart is a combination of high trust and joy with a low sadness and disgust. That reflects the situation Trump is in right now. Won election but with the lowest popular vote ever compare to his opponent Hilary Clinton. 
In comparison, Reagan is more balanced over all emotions, and is more similar to Obama and Carter. 

### Conclusion

Reagan and Trump share a lot in their speech delivering style. They both have a direct, simple and down-to-earth style. But concerning the emotions, the inaugural speeches unveil two different men.
Reagan won popular vote at his first election by a margin of 51-41% 
< Here are the 1980 numbers: Ronald Reagan crushed Jimmy Carter, an incumbent president, with the popular vote, by a margin of 51-41% (47.9% for Hillary to 46.8% for Trump.). Reagan won 44 of 50 states. He took the Electoral College 489-49. Even better, the victory was part of a Reagan Revolution of serious, substantive, thoughtful ideas, a genuine governing philosophy that went along with the win. It was Reaganism, Reagan conservatism that won, not some nebulous populism-nationalism. > 

![](http://www.patriotics.com/media/catalog/product/cache/4/image/9df78eab33525d08d6e5fb8d27136e95/p/r/presdents-collectibles130.jpg =100x100)
